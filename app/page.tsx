  ...
  return (
    <main className="ml-10 mr-5 flex min-h-screen flex-col justify-items-start justify-center gap-y-4">
      ...
      <div className='flex flex-col'>
        ...
        <TypeAnimOrder className='text-gray-500 text-3xl' text="and an aspiring software developer with an interest in computer vision, game development, and full-stack development." show={activeIndex >= 2} showNext={setNextActive} noAnim={activeIndex >= 3}/>
      </div>
